...
import 'package:prajna_admin/const.dart';
import 'package:prajna_admin/main.dart';
  ...
  Future<Null> handleSignIn() async {
    ...
    if (firebaseUser != null) {
      ...
      final QuerySnapshot result =
          await Firestore.instance.collection('user').where('id', isEqualTo: firebaseUser.uid).getDocuments();
